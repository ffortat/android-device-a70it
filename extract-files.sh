...
adb pull /system/lib/hw/gralloc.archos.so ../../../vendor/$MANUFACTURER/$DEVICE/proprietary/gralloc.archos.so
...
# All the blobs necessary for g8
PRODUCT_COPY_FILES += \\
    ...
    vendor/__MANUFACTURER__/__DEVICE__/proprietary/gralloc.archos.so:system/vendor/lib/hw/gralloc.archos.so \\
